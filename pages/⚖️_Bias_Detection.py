...
3. You will not take any medical action based on the output of this tool. \n   
    ...
    if task == "Generate a sample note and check for bias":
        ...
        desired_note_content = st.sidebar.text_input("Please enter a specialty and diagnoses for your generated progress note:", value="Oncology: Breast Cancer")
