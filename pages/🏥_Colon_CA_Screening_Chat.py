...
if st.secrets["use_docker"] == "True" or check_password2():
    ...
    final_query = f'Follow this system command when responding: {rag_prompt} Here, Grade B should be considered a *strong* recommendation, as strong as A. Now, using terminology appropriate for a {user_role}, please answer the following question: {query}.'
