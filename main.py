...
def check_password():
    ...
    def password_entered():
        ...
        if st.session_state["password"] == st.secrets["password"] or st.session_state["password2"] == st.secrets["password2"] or st.session_state["password2"] == st.secrets["password2"]:
...
if check_password() or st.secrets.use_docker == "True":
